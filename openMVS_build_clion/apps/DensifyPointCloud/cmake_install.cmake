# Install script for directory: /home/finley/CODE/MVS/openMVS/apps/DensifyPointCloud
...
file(INSTALL DESTINATION "/usr/local/bin/OpenMVS" TYPE EXECUTABLE FILES "/home/finley/CODE/MVS/openMVS_build_clion/bin/DensifyPointCloud")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/OpenMVS/DensifyPointCloud" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/OpenMVS/DensifyPointCloud")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/OpenMVS/DensifyPointCloud"
